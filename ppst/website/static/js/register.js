...
const confirmPasswordInput = document.getElementById('confirm-passwd');
...
confirmPasswordInput.addEventListener('focus', () => {
    confirmPasswordInput.placeholder = 'Reenter your password';
});
confirmPasswordInput.addEventListener('blur', () => {
    confirmPasswordInput.placeholder = ''; // Clear the placeholder when the user leaves the field
});
