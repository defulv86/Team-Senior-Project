# migrate_regular_fixture.py will install the same accounts as the other fixture, except that the test data is not fake.
# 100% of this data is real, since it has been taken by people. 
# For a large set of data, please refer to the migrate_fake_test_data_fixture.py that has been randomized generated and the responses/results are also randomized. The fake data will be mixed in with the real data.
import os
import subprocess
...
fixture_script = "regular_fixture.py"  # Ensure fixture.py is in the same directory
