# migrate_fake_test_data_fixture.py will install the fake_test_data_fixture.py into the database.
# 90% of this data is fake and is not real data. Majority of the data that is fake was generated to fill in more completed tests. For only real data that has been taken by actual patients, please refer to migrate_regular_fixture.py.
import os
import subprocess
...
fixture_script = "fake_data_fixture.py"  # Ensure fixture.py is in the same directory
